...
export default function PricePrediction() {
  ...
  const handlePredict = async () => {
    ...
    try {
      const response = await fetch(`http://127.0.0.1:5002/predict-price?crop=${crop}`, {
        method: "GET",
      ...
      alert("Cannot connect to server. Please check if your price_app.py backend is running.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
          ...
          <div className="lg:col-span-5 p-6 sm:p-10 flex flex-col justify-between bg-slate-50/50">
            <div className="space-y-6">
              ...
              {/* 💡 SUGGESTION POP BLOCK (PLACED DIRECTLY DOWNSIDE OF CHOOSE YOUR CROP) */}
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 bg-white min-h-[480px] flex flex-col justify-center">
            {!prediction ? (
              ...
              <div className="space-y-6">
                ...
                {/* THE ESTIMATED RETURN CALCULATOR CARD (VISUALLY RENDERS ONLY IF ACTIVE GENERATED BY CALC STATE INPUTS) */}
                {showCalculator && (
